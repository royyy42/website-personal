...
<head>
    <title>TravelBangko | Sign Up</title>
    <link rel="icon" href="image/TravelBangko.jpg">
        ...
        <center>
            <div style="padding-top: 125px;">
                <a href="index.php" onclick="window.close();">
                    <img src="image/TravelBangko.jpg" class="img-responsive" style="width: 100px; height: 100px;">
                </a>
